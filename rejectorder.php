					...
					<div class="row">
						<div class="col-md-4 col-sm-4">
							<div class="panel panel-success">
								<div class="panel-heading"> Rejected Order Info</div>
								<div class="panel-body">
									<p>Details: </p>
									<?php
										echo "<p>Order with ID: "; echo $orderid; echo " has been rejected</p>";
									?>									
									<p>Your email for rejected order has been sent<p>
								</div>
